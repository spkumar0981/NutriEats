...
public interface UserRepository extends JpaRepository<User, Long> {
    ...
    @Query(value = "SELECT CUSTOMER.FIRST_NAME, CUSTOMER.LAST_NAME, CUSTOMER.USER_NAME, CUSTOMER.PHONE_NUMBER, LV.LOOKUP_VALUE_CODE, LV.LOOKUP_VALUE, S.CUSTOMER_INPUT, S.DIETITIAN_INPUT, S.AMOUNT, MEAL.LOOKUP_VALUE_CODE AS MEAL_LOOKUP_CODE, MEAL.LOOKUP_VALUE AS MEAL_LOOKUP_VALUE " +
            "FROM USER CUSTOMER " +
    ...
    @Query(value = "SELECT DIETITIAN.FIRST_NAME, DIETITIAN.LAST_NAME, DIETITIAN.USER_NAME, DIETITIAN.PHONE_NUMBER, LV.LOOKUP_VALUE_CODE, LV.LOOKUP_VALUE, S.CUSTOMER_INPUT, S.DIETITIAN_INPUT, S.AMOUNT, MEAL.LOOKUP_VALUE_CODE AS MEAL_LOOKUP_CODE, MEAL.LOOKUP_VALUE AS MEAL_LOOKUP_VALUE " +
            "FROM USER DIETITIAN " +
